...
# can there be only past assemblies? There should always be a pending/future assembly
  ...
  Scenario Outline: Buttons in assembly history view according to role
    ...
    Examples:
      ...
      |supervisor |moderator | future       |pending       | supervisor   |Einberufung ändern |Protokoll abschließen| success|
      ...
      |executive  |          | pending      | past         | executive    |Einberufung ändern |Protokoll abschließen| success|
